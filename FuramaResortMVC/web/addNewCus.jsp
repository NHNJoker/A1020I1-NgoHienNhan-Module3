        ...
        <div class="col-lg-6">
            <form action="/customer?actionUser=addNewCus" method="post">
                <div class="form-group">
                    ...
                    <input value="${name}" type="text" class="form-control" id="inputNameCus" name="inputNameCus">
                    <label class="text-danger" for="inputNameCus" id="msgName">${msgName}</label>
                </div>
                <div class="form-group">
                    <label for="inputDateOfBirth">Date of birth</label>
                    <input value="${date}" type="date" class="form-control" id="inputDateOfBirth" name="dateOfBirthCus">
                    <label class="text-danger" for="inputDateOfBirth" id="msgDate">${msgDate}</label>
                </div>
                <div class="form-group">
                    <label for="inputID">ID card</label>
                    <input value="${idCard}" type="text" class="form-control" id="inputID" name="idCus">
                    <label class="text-danger" for="inputID" id="msgID">${msgID}</label>
                </div>
                <div class="form-group">
                    <label for="inputPhone">Phone</label>
                    <input value="${phone}" type="text" class="form-control" id="inputPhone" name="phoneCus">
                    <label class="text-danger" for="inputPhone" id="msgPhone">${msgPhone}</label>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmailEmployee">Email address</label>
                    <input value="${email}" type="email" class="form-control" id="exampleInputEmailEmployee"
                           aria-describedby="emailHelpEmployee" name="emailCus">
                ...
                <div class="form-group">
                    ...
                    <input value="${address}" type="text" class="form-control" id="inputAddressCus"
