...
<div class="container-fluid">
    ...
    <div class="row m-3">
        ...
        <div class="col-xl-3">
            <form class="input-group" action="/contract?actionUser=search" method="post">
        ...
        <div class="col-lg-12">
            <table id="tableContract" class="table table-striped table-bordered" style="width: 100%">
                ...
                <tr>
                    ...
                    <th scope="col">Name accompanied service</th>
                    <th scope="col">Price accompanied service</th>
                ...
                <c:forEach var="contract" items="${listContract}" varStatus="loop">
                    <tr>
                        ...
                        <td><c:out value="${contract.nameAccompaniedService}"/></td>
                        <td><c:out value="${contract.priceAccompaniedService}"/></td>
                        <td><c:out value="${contract.total}"/></td>
                        <td>
                            <a href="/contract?actionUser=edit&idContract=${contract.idContract}">
                                <button type="submit" class="btn btn-outline-primary">edit</button>
                            </a>
                        </td>
                        <td>
                            <a type="button" class="btn btn-outline-primary text-primary" data-toggle="modal"
                               data-target="#exampleModal${contract.idContract}">
                                Delete
                            </a>
                            <div class="modal fade" id="exampleModal${contract.idContract}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h5>
                                                Do you agree to delete ${contract.nameCus} customer's contract?</h5>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline-primary text-primary" data-dismiss="modal">Close</button>
                                            <a href="/contract?actionUser=delete&idContract=${contract.idContract}" class="btn btn-outline-primary text-primary">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
