        ...
        <div class="col-lg-6">
            <form action="/employee?actionUser=edit" method="post">
                ...
                <div class="form-group">
                    ...
                    <input value="${employeeServlet.nameOfEmployee}${name}" type="text" class="form-control"
                           id="inputNameEmployee" name="nameEmployee">
                    <label class="text-danger" for="inputNameEmployee" id="msgName">${msgName}</label>
                </div>
                <div class="form-group">
                    <label for="inputDateOfBirth">Date of birth</label>
                    <input value="${employeeServlet.dateOfBirth}${date}" type="date" class="form-control" id="inputDateOfBirth"
                ...
                <div class="form-group">
                    ...
                    <input value="${employeeServlet.id}${idCard}" type="text" class="form-control" id="inputID"
                           name="idEmployee">
                    <label class="text-danger" for="inputID" id="msgID">${msgID}</label>
                </div>
                <div class="form-group">
                    <label for="inputPhone">Phone</label>
                    <input value="${employeeServlet.phone}${phone}" type="text" class="form-control" id="inputPhone"
                           name="phoneEmployee">
                    <label class="text-danger" for="inputPhone" id="msgPhone">${msgPhone}</label>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmailEmployee">Email address</label>
                    <input value="${employeeServlet.email}${email}" type="email" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input value="${employeeServlet.address}${address}" type="text" class="form-control" id="inputAddressEmployee"
                ...
                <div class="form-group">
                    ...
                    <input value="${employeeServlet.salary}${salary}" type="text" class="form-control" id="inputSalaryEmployee"
