        ...
        <div class="col-lg-6">
            <form action="/service?actionUser=edit" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input value="${detailService.name}" type="text" class="form-control" id="nameService" name="nameService">
                </div>
                <div class="form-group">
                    <label for="areaUsed">Area used</label>
                    <input value="${detailService.areaUsed}" type="text" class="form-control" id="areaUsed" name="areaUsed">
                </div>
                <div class="form-group">
                    <label for="numberOfFloors">Number of floors</label>
                    <input value="${detailService.numOfFloors}" type="text" class="form-control" id="numberOfFloors" name="numberOfFloors">
                </div>
                <div class="form-group">
                    <label for="maxPeople">Max people</label>
                    <input value="${detailService.maxPeoples}" type="text" class="form-control" id="maxPeople" name="maxPeople">
                </div>
                <div class="form-group">
                    <label for="rentalCosts">Rental costs</label>
                    <input value="${detailService.rentalCosts}" type="text" class="form-control" id="rentalCosts" name="rentalCosts">
                </div>
                <div class="form-group">
                ...
                <input type="text" style="display: none" value="${detailService.linkImg}" name="img">
