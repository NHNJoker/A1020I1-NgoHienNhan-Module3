...
public class ServiceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (actionUser.equals("addNewService")) {
                String imgFileName = uploadImg(request,response);
                ...
                String linkImg = null;
                if (uploadImg(request,response) != null){
                    linkImg = "imageService/" + uploadImg(request,response);
                }else {
    ...
    protected String uploadImg(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
